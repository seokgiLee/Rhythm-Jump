...
public class StageDataManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        stageDatas.Add(new StageData(8, 10, 3, 3, 2, 0.3f, new int[] { 9, 0, 10, 0, 9, 0, 10, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 9, 0, 10, 0, 9, 0, 10, 0, 0 }, 0));
        stageDatas.Add(new StageData(9, 10, 1, 5, 2, 0.3f, new int[] { 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 10, 0, 0 }, 0));
        stageDatas.Add(new StageData(10, 10, 2, 2, 1, 0.5f, new int[] { 5, 0, 7, 0, 6, 0, 8, 0, 5, 0, 7, 0, 6, 0, 8, 0, 5, 0, 7, 0, 6, 0, 8, 0, 5, 0, 7, 0, 6, 0, 8, 0, 1, 0, 2, 0, 3, 0, 4, 0, 0 }, 0));
        stageDatas.Add(new StageData(11, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(12, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(13, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(14, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(15, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(16, 10, 3, 3, 1.5f, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(17, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(18, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(19, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(20, 10, 3, 3, 2, 0.25f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
