...
public class StageDataManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        stageDatas.Add(new StageData(4, 30, 2, 3, 2, 0.3f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0, 0, 7, 0, 8, 0, 7, 0, 0, 5, 0, 0, 7, 0, 0, 6, 0, 0, 8, 0, 0 }, 0));
        stageDatas.Add(new StageData(5, 30, 3, 2, 2, 0.3f, new int[] { 5, 0, 6, 0, 5, 0, 6, 0, 0, 7, 0, 8, 0, 7, 0, 8, 0, 11, 0, 11, 0 }, 0));
        stageDatas.Add(new StageData(6, 30, 5, 1, 2, 0.3f, new int[] { 7, 0, 0, 8, 0, 0, 7, 0, 0, 8, 0, 0, 7, 0, 0, 8, 0, 0, 7, 0, 0, 8, 0, 0 }, 0));
        ...
        stageDatas.Add(new StageData(13, 10, 2, 4, 2, 0.25f, new int[] { 11, 0, 11, 0, 5, 0, 6, 0, 5, 0, 6, 0, 11, 0, 11, 0, 5, 0, 6, 0, 5, 0, 6, 0, 11, 0, 11, 0, 5, 0, 6, 0, 5, 0, 6, 0, 11, 0, 11, 0, 11, 0, 11, 0}, 0));
        stageDatas.Add(new StageData(14, 10, 4, 2, 2, 0.25f, new int[] { 8, 0, 11, 0, 11, 0, 8, 0, 11, 0, 11, 0, 7, 0, 11, 0, 11, 0, 11, 0, 8, 0, 11, 0, 11, 0, 8, 0, 6, 0, 5, 0, 6, 0, 5, 0 }, 0));
        stageDatas.Add(new StageData(15, 10, 3, 3, 1, 0.25f, new int[] { 1, 0, 2, 0, 1, 0, 1, 0, 11, 0, 5, 0, 5, 0, 6, 0, 11,0,11,0,11,7,0,8,0,7,0,8,0,11,0 }, 0));
        stageDatas.Add(new StageData(16, 10, 3, 4, 1.5f, 0.25f, new int[] { 10, 0, 11, 0, 11, 0, 9, 0, 11, 0, 11, 0, 10, 0, 11, 0, 11, 0, 10, 0, 11, 0, 11, 0, 9, 0, 11, 0, 11, 0, 10, 0, 11, 0, 11, 0 }, 0));
        stageDatas.Add(new StageData(17, 10, 4, 3, 2, 0.25f, new int[] { 11, 0, 7, 0, 11, 0, 8, 0, 11, 0, 6, 0, 11, 0, 5, 0, 10, 0, 9, 0, 7, 0, 8, 0, 0 }, 0));
        stageDatas.Add(new StageData(18, 10, 3, 3, 2, 0.25f, new int[] { 10, 0, 9, 0, 10, 0, 9, 0, 9, 0, 9, 0, 10, 0, 11, 0, 10, 0, 9, 0, 11, 0, 11, 0, 5, 0, 6, 0, 5, 0, 6, 0 }, 0));
        stageDatas.Add(new StageData(19, 10, 2, 1, 1, 0.25f, new int[] { 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0 }, 0));
        stageDatas.Add(new StageData(20, 10, 4, 4, 1, 0.25f, new int[] { 11, 0, 11, 0, 11, 0, 11, 0, 7, 0, 8, 0, 11, 0, 11, 0, 11, 0, 11, 0, 8, 0, 7, 0, 11, 0, 11, 0, 11, 0, 11, 0, 5, 0, 6, 0, 11, 0, 11, 0, 11, 0, 11, 0, 5, 0, 6, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 11, 0, 9, 0, 0 }, 0));
