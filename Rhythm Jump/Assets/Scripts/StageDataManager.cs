...
public class StageDataManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        stageDatas.Add(new StageData(37, 15, 5, 2, 1f, 0.3f, new int[] { 7, 0, 102, 8, 0, 112, 7, 0, 102, 8, 0, 112, 7, 0, 102, 8, 0, 112, 7, 0, 102, 8, 0, 11, 11, 11, 11, 0, 5, 0, 6, 0, 7, 0,8,0,11,11,11,11,0, 0 }, 3.7f, 0.88f));
